...
export const LeafletFullScreenButton = () => {
    ...
    return (
        <a
            className="leaflet-full-screen-specific-name bg-white hover:bg-[#f4f4f4] h-10 w-10 rounded-md text-[22px] flex items-center justify-center border-2 border-black border-opacity-30 cursor-pointer"
            onClick={() => {
